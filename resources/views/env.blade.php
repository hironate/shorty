...
SHORTY_GENERATED_AT="{{$SHORTY_GENERATED_AT}}"
...
SHORTY_RECAPTCHA_SECRET_KEY="{{$SHORTY_RECAPTCHA_SECRET}}"
...
# Do not touch
SHORTY_RELDATE="{{env('VERSION_RELMONTH')}} {{env('VERSION_RELDAY')}}, {{env('VERSION_RELYEAR')}}"
SHORTY_VERSION="{{env('VERSION')}}"
