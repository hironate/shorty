...
## API keys
To authenticate a user to Shorty, you *must* provide an API key along with
each request to Shorty API endpoints, as a GET or POST parameter. (e.g `?key=API_KEY_HERE`)
...
## Response Type
The Shorty API will reply in `plain_text` or `json`. The response type can be
...
{
    "action": "shorten",
    "result": "https://shorty.codingmonk.tech/5kq"
}
```
...
```https://shorty.codingmonk.tech/5kq```
...
Example: GET `https://shorty.codingmonk.tech/api/v2/action/shorten?key=API_KEY_HERE&url=https://google.com&custom_ending=CUSTOM_ENDING&is_secret=false`
...
```json
{
  "links": [      
      ...
      {
          "url": "https://github.com/CodingMonkTech/shorty",
          "custom_ending": "shorty"
      }
  ]
}
```
        ...
        "shortened_links": [            
            {
                ...
                "short_url": "https://shorty.codingmonk.tech/b496"
            },
            {
                "long_url": "https://github.com/CodingMonkTech/shorty",
                "short_url": "https://shorty.codingmonk.tech/shorty"
            }
        ]
    }
}
...
Example: GET `https://shorty.codingmonk.tech/api/v2/action/lookup?key=API_KEY_HERE&url_ending=2`
...
Example: GET `https://shorty.codingmonk.tech/api/v2/data/link?stats_type=day&key=API_KEY_HERE&url_ending=5gk&response_type=json&left_bound=2017-02-28%2022:41:43&right_bound=2017-03-13%2022:21:43`
...
Example: GET `https://shorty.codingmonk.tech/api/v2/data/link?stats_type=country&key=API_KEY_HERE&url_ending=5gk&response_type=json&left_bound=2017-02-28%2022:41:43&right_bound=2017-03-13%2022:21:43`
...
You may test your integrations on https://codingmonk.tech after Signing up.
