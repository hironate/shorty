...
<div class="row" ng-controller="SetupCtrl" class="ng-root">
    ...
    <div class='col-md-6 setup-body well'>
        ...
        <form class='setup-form' method='POST' action='/setup'>
            ...
            <p>
                Database Name:
                <setup-tooltip content="Name of existing database. You must create the Shorty database manually."></setup-tooltip>
            </p>
            <input type='text' class='form-control' name='db:name' value='shorty'>


            <h4>Application Settings</h4>

            <p>Application Name:</p>
            <input type='text' class='form-control' name='app:name' value='shorty'>

            <p>Application Protocol:</p>
            <input type='text' class='form-control' name='app:protocol' value='http://'>

            <p>Application URL (path to shorty; do not include http:// or trailing slash):</p>
            ...
            <p>
                Redirect URL:
                <setup-tooltip content="Required if you wish to redirect the index page or 404s to a different website. To use shorty, login by directly heading to yoursite.com/login first."></setup-tooltip>
            </p>
            ...
            <h4>
                ...
                <setup-tooltip content="These credentials will be used for your admin account in shorty."></setup-tooltip>
            </h4>

            <p>Admin Username:</p>
            <input type='text' class='form-control' name='acct:username' value='shorty'>

            <p>Admin Email:</p>
            <input type='text' class='form-control' name='acct:email' value='shorty@admin.tld'>

            <p>Admin Password:</p>
            <input type='password' class='form-control' name='acct:password' value='shorty'>
            ...
            <p>Theme (<a href='https://github.com/cydrobolt/shorty/wiki/Themes-Screenshots'>screenshots</a>):</p>
...
<div class='setup-footer well'>
    shorty is <a href='https://opensource.org/osd' target='_blank'>open-source
    software</a> licensed under the <a href='//www.gnu.org/copyleft/gpl.html'>GPLv2+
    License</a>.

    <div>
        shorty Version <?php echo e(env('VERSION')); ?> released <?php echo e(env('VERSION_RELMONTH')); ?> <?php echo e(env('VERSION_RELDAY')); ?>, <?php echo e(env('VERSION_RELYEAR')); ?> -
        <a href='//github.com/codingmonktech/shorty' target='_blank'>Github</a>
    </div>
</div>
